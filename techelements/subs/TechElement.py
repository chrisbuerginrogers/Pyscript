...
DEVICE_MESSAGE_MAP = {  # B = u8, b = i8, H = u16, h = i16, i = i32
    ...
    0x0A: ("Motor",        "<BBBHhbi",     ['port', 'state', 'angle', 'power', 'speed', 'position']),
    ...
    0x10: ("imu gesture",  "<Bb",           ['gesture']),
    0x11: ("motor gesture","<Bbb",          ['port', 'gesture']),
}

ACK_MAP = {  #[123, 139, 141,]
    0x7B: ("Motor_run",     "<BB",           ['ack']),
    0x8B: ("Motor_stop",    "<BB",           ['ack']),
    0x8D: ("Motor_setspd",  "<BB",           ['ack']),
}
...
commands = {
    ...
    'motor_angle':  ('<BBiB',  MOTOR_RUN_FOR_DEGREES_COMMAND, {'values':{'a':1, 'b':100, 'c':1}}),
